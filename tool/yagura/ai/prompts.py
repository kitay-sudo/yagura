...
WATCH_ALERT_ENRICHMENT_PROMPT = """Ты — security-аналитик. Сервер мониторится Yagura, обнаружено отклонение.
...
Дай 3 строки:
1. Это серьёзно или ложная тревога? (одно предложение)
2. Что делать прямо сейчас? (одна команда или одно действие)
