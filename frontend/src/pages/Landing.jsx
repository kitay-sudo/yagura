...
const CHANGELOG = [
  ...
  },
  {
    version: '0.6.0',
    date: '2026-04-28',
    title: 'Whitelist 2.0 + heartbeat в Telegram',
    highlights: [
      'yagura whitelist auto / scan-bundled / explain / remove-pack / audit-log — полный набор для управления списком исключений',
      'W-NET-001 умеет различать эфемерные порты известных сервисов и собственные артефакты Yagura',
      'W-PROC-002 для процессов на localhost DB-сокетах понижает severity до LOW (это почти всегда легитимные приложения, не майнеры)',
      'Heartbeat и startup-уведомления в Telegram — видно, что watchdog жив',
    ],
  },
];
